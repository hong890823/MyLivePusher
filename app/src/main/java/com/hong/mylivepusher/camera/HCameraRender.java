...
import com.hong.mylivepusher.util.DisplayUtil;

import java.nio.ByteBuffer;
import java.nio.ByteOrder;
import java.nio.FloatBuffer;

public class HCameraRender implements HEGLSurfaceView.HGLRender, SurfaceTexture.OnFrameAvailableListener{
    ...
    private HCameraFboRender hCameraFboRender;
    ...
    HCameraRender(Context context) {
        this.context = context;

        screenWidth = DisplayUtil.getScreenWidth(context);
        screenHeight = DisplayUtil.getScreenHeight(context);

        hCameraFboRender = new HCameraFboRender(context);
    ...
    public void onSurfaceCreated() {
        hCameraFboRender.onCreate();
        String vertexSource = HShaderUtil.getRawResource(context, R.raw.vertex_shader);
        String fragmentSource = HShaderUtil.getRawResource(context, R.raw.fragment_shader);
        ...
        if(GLES20.glCheckFramebufferStatus(GLES20.GL_FRAMEBUFFER) != GLES20.GL_FRAMEBUFFER_COMPLETE) {
            Log.e("Hong", "fbo wrong");
        } else {
            Log.e("Hong", "fbo success");
        }
    ...
    public void onDrawFrame() {
        ...
        GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, 0);
        hCameraFboRender.onChange(width, height);
        hCameraFboRender.onDraw(fboTextureId);
    }
