...
public class HYuvRender implements HEGLSurfaceView.HGLRender{
    ...
    private HYuvFboRender hYuvFboRender;

    private float[] matrix = new float[16];
    private int u_matrix;

    public HYuvRender(Context context) {
        this.context = context;
        hYuvFboRender = new HYuvFboRender(context);
    ...
    public void onSurfaceCreated() {
        hYuvFboRender.onCreate();
        String vertexShader = HShaderUtil.getRawResource(context, R.raw.vertex_shader_yuv);
        String fragmentShader = HShaderUtil.getRawResource(context, R.raw.fragment_shader_yuv);
        program = HShaderUtil.createProgram(vertexShader, fragmentShader);
    ...
    public void onSurfaceChanged(int width, int height) {
        ...
        hYuvFboRender.onChange(width, height);
    }
    ...
    public void onDrawFrame() {
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, 0);
        GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, 0);
        hYuvFboRender.onDraw(textureId);
